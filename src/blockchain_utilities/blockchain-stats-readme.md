# Lunexa Blockchain Stats

Lunexa Blockchain Stats utlity exports daily statistics for the lunexa blockchain from creation through current state.

## Usage:

See also the utility's help option. `lunexa-blockchain-stats --help`
...
- `lunexa-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `lunexa-blockchain-stats | save-to-database.sh`
