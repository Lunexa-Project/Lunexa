...
RUN	git clone https://github.com/lunexa-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/lunexa-project/lunexa
...
if [ ! -d sigs ]; then
	git clone https://github.com/lunexa-project/gitian.sigs.git sigs
	cd sigs
