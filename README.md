...
Lunexa is a decentralized digital currency designed with privacy, security, and untraceability at its core. Built on the proven foundation of Monero's cryptographic principles, Lunexa incorporates initial modifications including adjusted fee structures and targeted source code improvements, with plans to introduce further enhancements to elevate user privacy and transaction efficiency.
...
Lunexa is a privacy-first cryptocurrency project that leverages modified Monero codebase as its technical foundation. Building upon Monero's battle-tested cryptographic principles, Lunexa aims to further improve privacy, usability, and performance while remaining fully decentralized and community-driven.
...
While Lunexa is built using modified Monero code, it is developing a distinct ecosystem—featuring innovations tailored to the evolving needs of our users. By building on Monero's solid foundation, we can spend our time improving what matters most to users instead of reinventing the wheel.
